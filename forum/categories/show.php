							...
							<div class="col-md-10">
								<div class="topic-content pull-right">
									...
									<div class="topic-info">
										<a href="<?php echo APPURL; ?>/categories/show.php?name=<?php echo $topic->category; ?>"><?php echo $topic->category; ?></a> >> <a href="profile.html"><?php echo $topic->user_name; ?></a> >> <?php echo $topic->created_at; ?> 
									</div>
								</div>
							</div>
						</div>
