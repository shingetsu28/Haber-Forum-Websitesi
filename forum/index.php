...
<?php
		...
		IFNULL(COUNT(replies.topic_id), 0) AS count_replies
	FROM
		topics
	LEFT JOIN
    ...
    <div class="container">
		<div class="row">
			<div class="col-md-8">
				<div class="main-col">
					<div class="block">
						<h1 class="pull-left">Oktay Haber Ajansi</h1>
							...
							<div class="col-md-10">
								<div class="topic-content pull-right">
									...
									<div class="topic-info">
										<a href="<?php echo APPURL; ?>/categories/show.php?name=<?php echo $topic->category; ?>"><?php echo $topic->category; ?></a> >> <a href="profile.html"><?php echo $topic->user_name; ?></a> >> Gönderildi: <?php echo $topic->created_at; ?> 
